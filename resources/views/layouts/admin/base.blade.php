@php use Modules\Settings\Models\Settings; @endphp
@php use Modules\Settings\Models\Seo; @endphp
    <!DOCTYPE html>
<!--
Author: Hadi Hilal
-->
...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('images/logo/icons/apple-touch-icon.png')}}">
    ...
    <link rel="manifest" href="{{asset('images/logo/icons/site.webmanifest')}}">
    <link rel="mask-icon" href="{{asset('images/logo/icons/safari-pinned-tab.svg')}}" color="#5bbad5">
                        ...
                        <div
                            ...
                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                ...
                                <span class="menu-link">
											<span class="menu-title">{{$seo->get('website_name')}}</span>
                                    ...
                                    <div class="menu-content d-flex align-items-center px-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="fw-bold d-flex align-items-center fs-5">{{auth()->user()->name}}
                                                <span
                                                    class="badge badge-light-success fw-bolder fs-9 px-2 py-1 ms-2">{{auth()->user()->super_admin ? 'Super Admin' : 'Assigned'}}</span>
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <a href="#" class="menu-link px-5">
												...
												<img class="w-15px h-15px rounded-1 ms-2"
                                                     src="/images/flags/{{ app()->getLocale()  === 'ar' ? 'ar.svg':'uk.svg'}}"
                                                     alt=""/></span></span>
                                    </a>
                                    <!--begin::Menu sub-->
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="https://www.linkedin.com/in/hadi-hilal" target="_blank"
                               class="text-gray-700 text-hover-primary">{{__('Powered By Hadi Hilal')}} </a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Menu-->
