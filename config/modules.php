...
//            'views/master' => ['LOWER_NAME', 'STUDLY_NAME'],
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            // app/Http/
            //  'admin-controller' => ['path' => 'app/Http/Controllers/Admin', 'generate' => true],
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'hadi'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Hadi Hilal'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'hadi-hilal@hotmail.com'),
        ],
