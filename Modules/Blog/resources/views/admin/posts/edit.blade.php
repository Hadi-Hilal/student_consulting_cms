...
@section('css')
    <style>
        .image-input-placeholder {
            background-image: url({{$post->image_link}});
        }
...
@section('content')
    ...
    <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
          action="{{route('admin.blogs.posts.update' , $post->id)}}"
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" name="publish"
                        ...
                        <option
                            @selected(old('publish' , $post->publish) === 'published') value="published"
                            class="text-uppercase"
                            selected="selected">{{__('published')}}</option>
                        <option
                            @selected(old('publish' , $post->publish) === 'archived') value="archived">{{__('archived')}}</option>
                    </select>
                    <!--end::Select2-->
                    <!--begin::Description-->
                    <div class="text-muted fs-7">{{__('Set the page status.')}}</div>
                        ...
                        <div class="d-flex fv-row">
                            ...
                            <div class="form-check form-check-custom form-check-solid">
                                ...
                                <input class="form-check-input me-3" name="featured" type="radio" value="1"
                                       id="kt_ecommerce_add_category_automation_0" @checked(old('featured', $post->featured) == 1)/>
                                <!--end::Input-->
                                <!--begin::Label-->
                        ...
                        <div class="d-flex fv-row">
                            ...
                            <div class="form-check form-check-custom form-check-solid">
                                ...
                                <input class="form-check-input me-3" name="featured" type="radio" value="0"
                                       @checked(old('featured', $post->featured) == 0)
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <div>
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control mb-2" value="{{old('keywords', $post->keywords)}}"
            ...
            <div class="d-flex justify-content-end">
                <!--begin::Button-->
                <a href="{{route('admin.blogs.posts.index')}}" id="kt_ecommerce_add_product_cancel"
