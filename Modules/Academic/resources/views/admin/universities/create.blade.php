...
@section('title' , __('Add New University'))
@section('css')
    <style>
...
@section('toolbar')
    ...
    @endphp
    <x-admin.breadcrumb pageTitle="Add New University" :breadcrumbItems="$breadcrumbItems"/>
                ...
                <div class="card-body text-center pt-0">
                    ...
                    <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                        ...
                        <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                            ...
                            <!--end::Icon-->
                            <!--begin::Inputs-->
                            <input type="file" name="ulogo" accept=".png, .jpg, .jpeg, .webp" required/>
                            <input type="hidden" name="avatar_remove"/>
                            <!--end::Inputs-->
                        </label>
                        <!--end::Label-->
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" class="form-control" id="location" name="location"
                               value="{{old('location' , 'Istanbul')}}"/>
                    </div>

                    <div class="mb-5">
                        <label class="required form-label" for="rank">{{__('Local Rank')}}</label>
                        <input type="text" class="form-control" id="rank" name="rank" value="{{old('rank' , 1)}}"/>
                    </div>
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" name="type"
                        ...
                        <option
                            @selected(old('type') === 'private') value="private" class="text-uppercase"
                            selected="selected">{{__('private')}}</option>
                        <option
                            @selected(old('type') === 'public') value="public">{{__('public')}}</option>
                    </select>
                    <!--end::Select2-->
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10 fv-row">
                        ...
                        <input type="text" class="form-control mb-2" id="title" name="title" value="{{old('title')}}"
                               placeholder="İstinye University"/>
                        <!--end::Input-->
                        <!--begin::Description-->
                        <div
                    ...
                    <div class="mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control mb-2" id="gslug" placeholder="İstinye University"/>
                    ...
                    <div class="mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control mb-2" id="video" name="video" value="{{old('video')}}"
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10 ">
                        ...
                        <input type="text" class="form-control mb-2" name="description" id="description"
                               ...
                               placeholder="Istinye University is one of the best Turkish private universities"/>
                        <!--end::Input-->
                        <!--begin::Description-->
                        <div
    ...
    <script>
        $(document).ready(function (e) {
            ...
            $('#gslug').on('input', function () {
                ...
                if (slug !== '') {
                    $('#link').addClass('text-primary').text("{{env('APP_URL')}}/universites/" + slug);
                    $('#slug').val(slug);
                } else {
