...
use Modules\Academic\Repositories\ProgramModelRepository;
use Modules\Academic\Repositories\ProgramRepository;
use Modules\Academic\Repositories\UniversityModelRepository;
...
class AcademicServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ProgramRepository::class, ProgramModelRepository::class);
        $this->app->bind(UniversityRepository::class, UniversityModelRepository::class);
    }
