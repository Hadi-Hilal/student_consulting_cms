...
@section('content')
    <x-admin.create-card title="New Testimonial" :formUrl="route('admin.testimonials.store')">
        ...
        <div class="row mb-10">
            ...
            <!--begin::Col-->
            <div class="col-xl-3">
                <div class="fs-6 fw-bold mt-2 mb-3">{{__('Student Image')}} <span class="text-danger">*</span>
                </div>
            </div>
            ...
            <div class="col-xl-9 fv-row">
                ...
                <!--end::Image input-->
                <!--begin::Hint-->
                <div class="form-text"> 100px * 100px</div>
                <!--end::Hint-->
            </div>
            <!--end::Col-->
        </div>
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-3">
                <div class="fs-6 fw-bold mt-2 mb-3"><i
                        class="bi bi-translate text-primary mx-1 "></i>{{__('Student Name')}} <span
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-3">
                <div class="fs-6 fw-bold mt-2 mb-3"><i
                        class="bi bi-translate text-primary mx-1 "></i>{{__('Student Comment')}} <span
                        class="text-danger">*</span></div>
            </div>
            <!--end::Col-->
            <!--begin::Col-->
