...
@section('toolbar')
    ...
    <div class="d-flex align-items-center gap-2 gap-lg-3">
        <a type="button" class="btn btn-sm btn-light-primary me-3" data-bs-toggle="modal"
        ...
        <a href="{{route('admin.subscribers.export')}}" type="button" class="btn btn-sm btn-light-primary me-3"
           id="export">
...
@section('content')
    <x-admin.table :model="$subscribers" search="Search In Subscribers"
        ...
        <tr class="text-start text-muted fw-bold fs-7 gs-0">
            ...
            <th class="min-w-150px">{{__('Lang')}}</th>
            <th class="min-w-150px">{{__('Joined Date')}}</th>
        </tr>
        </thead>
        <!--end::Table head-->
        <!--begin::Table body-->
        ...
        @foreach($subscribers as $subscriber)
            <tr>
                ...
                <td>
                    <a href="https://www.ipaddress.my/{{$subscriber->ip}}" target="_blank"> {{$subscriber->ip}}</a>
                </td>
                <td>
