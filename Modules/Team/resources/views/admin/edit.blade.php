...
@section('toolbar')
    @php
        $breadcrumbItems = [
            ...
            ['label' => 'Our Team' , 'url' => route('admin.teams.index')],
            ['label' => 'Edit Member'],
        ];
    @endphp
    <x-admin.breadcrumb pageTitle="Edit Member" :breadcrumbItems="$breadcrumbItems"/>
    <div class="d-flex align-items-center gap-2 gap-lg-3"></div>
@endsection

@section('content')
    <x-admin.create-card title="Edit Member" :formUrl="route('admin.teams.update' , $team->id)">
        @method('PUT')
        <!--begin::Row-->
        <div class="row mb-10">
            ...
            <div class="col-xl-9 fv-row">
                ...
                <div class="image-input image-input-outline " data-kt-image-input="true"
                    ...
                    <div class="image-input-wrapper w-125px h-125px bgi-position-center"
                         style="background-size: 75%; background-image: url({{$team->image}})"></div>
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-3">
                <div class="fs-6 fw-bold mt-2 mb-3"><i
                        class="bi bi-translate text-primary mx-1 "></i>{{__('Name')}} <span
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-3">
                <div class="fs-6 fw-bold mt-2 mb-3"><i
                        class="bi bi-translate text-primary mx-1 "></i>{{__('Position')}} <span
                        class="text-danger">*</span></div>
            </div>
            <!--end::Col-->
            <!--begin::Col-->
            ...
            <div class="col-xl-9 fv-row">
                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-30px w-50px"
                           @checked($team->publish == 'published')  type="checkbox" name="publish"
                           id="flexSwitch30x50"/>
                </div>
            </div>
        </div>
