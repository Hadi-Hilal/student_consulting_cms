...
@section('title' , __('Create New Member'))
...
@section('toolbar')
    ...
    @endphp
    <x-admin.breadcrumb pageTitle="Create New Member" :breadcrumbItems="$breadcrumbItems"/>
    <div class="d-flex align-items-center gap-2 gap-lg-3"></div>
@endsection

@section('content')
    <x-admin.create-card title="Create New Member" :formUrl="route('admin.teams.store')">
        <!--begin::Row-->
        <div class="row mb-10">
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-9 fv-row">
                <input type="text" class="form-control form-control-solid" name="position" value="{{old('position')}}"
                       placeholder="Hr"/>
