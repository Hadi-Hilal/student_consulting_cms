...
@section('content')
    <x-admin.table :model="$admins" search="Search In Admins" :formUrl="route('admin.admins.deleteMulti')">
        ...
        <tr class="text-start text-muted fw-bold fs-7 gs-0">
            ...
            <th class="min-w-125px">{{__('Grant Access')}}</th>
        ...
        @foreach($admins as $admin)
            <tr>
                    ...
                    <div class="d-flex flex-column">
                        <p class="text-gray-800 mb-1">{{$admin->name}}
                            @if($admin->super_admin)
                                <i class="bi bi-star-fill mx-1 text-warning"></i>
                            @endif
                        </p>
                ...
                <td>
                            ...
                            {{$admin->super_admin ? __('Super Admin') : __('Assigned')}}
                        </span>
                </td>
                <td>
                ...
                <td>
                    ...
                    <a href="{{route('admin.admins.assign' , [$admin->id])}}"
                       class="btn btn-outline-success btn-outline btn-sm">
                        {{$admin->super_admin ? __('Empower As Assigned'): __('Empower As Super Admin') }}
                    </a>
