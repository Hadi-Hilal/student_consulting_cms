...
@section('content')
    <x-admin.create-card title="Seo Configurations" :formUrl="route('admin.seo.store')">
        <div class="row mb-8">
            <div class="col-xl-6">
                <img src="{{asset('images/custom/seo.jpg')}}" class="img-thumbnail" alt="{{__('Website Name')}}"/>
            </div>
            <div class="col-xl-6">
                <img src="{{asset('images/custom/green-tea-keywords-in-search-results.png')}}" class="img-thumbnail"
                     alt="{{__('Website Name')}}"/>
            </div>
        </div>
        <div class="row mb-8">
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-3">
                <div class="fs-6 fw-bold mt-2 mb-3"><i
                        class="bi bi-translate text-primary mx-1 "></i>{{__('Website Secondary Title')}}</div>
            </div>
            <!--end::Col-->
            <!--begin::Col-->
            <div class="col-xl-9 fv-row">
                <input type="text" class="form-control form-control-solid" name="data[second_title]"
                       value="{{$seo->get('second_title')}}"
                       placeholder="Boots your website traffic today its just text "/>
            </div>
        </div>
